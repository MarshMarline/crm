							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-call">
									...
									<c:forEach items="${appellation}" var="appe">
										<option value="${appe.value}">${appe.text}</option>
									</c:forEach>
								</select>
							</div>
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-status">
								  ...
								  <c:forEach items="${clueState}" var="state">
									  <option id="${state.value}">${state.text}</option>
								  </c:forEach>
								</select>
							</div>
						</div>
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody id="show-clues">
                        ...
                        <tr class="active">
                            <td><input type="checkbox" /></td>
                            <td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='uri.do?uri=clue/detail';">李四先生</a></td>
                            <td>动力节点</td>
                            <td>010-84846003</td>
                            <td>12345678901</td>
                            <td>广告</td>
