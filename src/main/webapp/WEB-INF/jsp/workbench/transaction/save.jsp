...
<script>
	$(function () {
		...
		//用正则表达式把获取到的map字符串转换成json字符串
		//{02需求分析=25, 01资质审查=10, 03价值建议=40, 07成交=100, 08丢失的线索=0, 04确定决策者=60, 05提案/报价=80, 09因竞争丢失关闭=0, 06谈判/复审=90}
		var str = ""+"${possibilityMap}";
		str = str.replace(/[,]+[ ]/g,",\"");
		str = str.replace(/[{]/g,"{\"");
		str = str.replace(/[=]/g,"\":");
		//转换后：{"02需求分析":25,"01资质审查":10,"03价值建议":40,"07成交":100,"08丢失的线索":0,"04确定决策者":60,"05提案/报价":80,"09因竞争丢失关闭":0,"06谈判/复审":90}
		//把字符串解析成json对象
		var possibilityMap = JSON.parse(str);
		//alert(possibilityMap);//object Object
		...
		$("#create-customerName").typeahead({
			source: function (query, process) {
			    if($("#create-customerName").val() != null && $("#create-customerName").val() != "") {
                    $.get(
		...
		$("#create-transactionStage").change(function () {
			$("#create-possibility").val(possibilityMap[$("#create-transactionStage").val()]);
		});
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<table id="activityTable3" class="table table-hover" style="width: 900px; position: relative;top: 10px;">
						...
						<tbody>
							<tr>
								<td><input type="radio" name="activity" id="dd43fdbc63894cd3a140dc3e7c59877a"/></td>
								<td>皮卡丘进化</td>
								<td>2020-10-10</td>
								<td>2020-10-20</td>
								<td>zhangsan</td>
							...
							<tr>
								<td><input type="radio" name="activity" id="bd7e4c27086346759be4359e69f87424"/></td>
								<td>bilibili推广</td>
								<td>2020-10-10</td>
								<td>2020-10-20</td>
								<td>zhangsan</td>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<table id="activityTable" class="table table-hover" style="width: 900px; position: relative;top: 10px;">
						...
						<tbody>
							<tr>
								<td><input type="radio" name="activity" id="20aa8efe5ee54036a51fe0ad8f6fa5e7"/></td>
								<td>马云</td>
